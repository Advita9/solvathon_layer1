...
| `MIN_SPEECH_DURATION`| `2.0` | Minimum silence duration to trigger STT. |
...
| `WHISPER_MODEL` | `faster-whisper-base.en` | Path or name of the STT model. |
...
### 3. "Edge TTS Timeout"
- **Cause**: Cloud connectivity issues to Microsoft's servers.
- **impact**: Integration falls back to silence or logs error.
- **Fix**: Check internet connection. The system is designed to use **Piper** for English/Telugu which is offline-capable.
